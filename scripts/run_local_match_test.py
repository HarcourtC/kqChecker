...
if resp_path.exists():
    ...
    resp = {
        "data": {
            "list": [
                {"operdate": "2025-11-11 19:25:00", "teachNameList": "Teacher X", "subjectBean": {"sName": "Some Subject"}},
                {"operdate": "2025-11-11 14:03:00", "teachNameList": "Teacher B", "subjectBean": {"sName": "Test Course B"}},
                {"operdate": "2025-11-11 16:05:00", "teachNameList": "Teacher A", "subjectBean": {"sName": "Test Course A"}},
            ]
        }
    }
...
matches = match_records_by_time(resp, weekly, date_prefix=date_prefix, before_minutes=20, after_minutes=5, time_fields=('operdate','watertime','intime'))
